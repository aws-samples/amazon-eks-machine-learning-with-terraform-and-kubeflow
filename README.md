...
3. *Ensure that you have at least version 1.16.73 of the AWS CLI installed, or this step will faill.* In ```eks-cluster``` directory, execute: ```./update-kubeconfig.sh``` to update kube configuration 
