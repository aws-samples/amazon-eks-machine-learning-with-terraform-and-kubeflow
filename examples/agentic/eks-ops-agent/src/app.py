...
def _init_otel():
    ...
    try:
        ...
        resource = Resource.create({
            "service.name": os.getenv("OTEL_SERVICE_NAME", "eks-ops-agent"),
        })
...
def main():
    ...
    try:
        ...
        logger.info("LangChain OTEL instrumentation enabled (scope: opentelemetry.instrumentation.langchain)")
    except Exception as e:
