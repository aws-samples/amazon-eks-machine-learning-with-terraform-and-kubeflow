...
To launch the data processing job, execute:
    ...
    helm install --debug nxd-llama3-70b-ptl\
        ...
        -f examples/neuronx-distributed/llama3_70b_ptl/wikicorpus.yaml -n kubeflow-user-example-com
...
To launch compile job:
    ...
    helm install --debug nxd-llama3-70b-ptl\
        ...
        -f examples/neuronx-distributed/llama3_70b_ptl/compile.yaml -n kubeflow-user-example-com
...
To launch the pre-training job:
    ...
    helm install --debug nxd-llama3-70b-ptl\
        charts/machine-learning/training/pytorchjob-distributed \
        -f examples/neuronx-distributed/llama3_70b_ptl/pretrain.yaml -n kubeflow-user-example-com
