...
To download Hugging Face Llama3 8B Instruct pre-trained model weights, replace `YourHuggingFaceToken` with your Hugging Face token below, and execute:
    ...
    cd ~/amazon-eks-machine-learning-with-terraform-and-kubeflow
    helm install --debug rayserve-llama32-11b-vis-inst     \
...
Uninstall the Helm chart at completion:
    ...
    helm uninstall rayserve-llama32-11b-vis-inst -n kubeflow-user-example-com
...
To build Ray Serve engine:
    ...
    helm install --debug rayserve-llama32-11b-vis-inst     \
            ...
            -f examples/rayserve/meta-llama32-11b-vis-inst-vllm/engine_config.yaml \
            -n kubeflow-user-example-com
...
To launch Ray Service,  execute:
    ...
    helm install --debug rayserve-llama32-11b-vis-inst \
        ...
        -f examples/rayserve/meta-llama32-11b-vis-inst-vllm/rayservice.yaml -n kubeflow-user-example-com
