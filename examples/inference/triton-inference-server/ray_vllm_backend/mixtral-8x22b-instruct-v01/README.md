# Serve Mixtral 8x22B Instruct v0.1 using Triton Inference Server with vLLM and Ray
...
To download Hugging Face Mixtral 8x22B Instruct v0.1 pre-trained model weights, replace `YourHuggingFaceToken` with your Hugging Face token below, and execute:
    ...
    cd ~/amazon-eks-machine-learning-with-terraform-and-kubeflow
    helm install --debug triton-server-mixtral-8x22b-instruct-v01-ray-vllm    \
...
Uninstall the Helm chart at completion:
    ...
    helm uninstall triton-server-mixtral-8x22b-instruct-v01-ray-vllm-n kubeflow-user-example-com
...
To launch Triton server:
    ...
    helm install --debug triton-server-mixtral-8x22b-instruct-v01-ray-vllm\
        ...
        -f examples/inference/triton-inference-server/ray_vllm_backend/mixtral-8x22b-instruct-v01/triton_server.yaml -n kubeflow-user-example-com
...
Triton server logs are available in `/efs/home/triton-server-mixtral-8x22b-instruct-v01-ray-vllm/logs` folder. 
