...
This example illustrates how to use [Ray Serve](../../../charts/machine-learning/training/rayserve/) Helm chart to serve [Meta Llama 3.3 70B Instruct](https://huggingface.co/meta-llama/Llama-3.3-70B-Instruct) model, using multi-GPU, multi-node deployment. 
...
To build Ray Serve engine config:
    ...
    helm install --debug rayserve-llama33-70b-instruct    \
            ...
            -f examples/inference/rayserve/meta-llama33-70b-instruct-vllm/engine_config.yaml \
            -n kubeflow-user-example-com
...
To launch Ray Service,  execute:
    ...
    helm install --debug rayserve-llama33-70b-instruct\
        ...
        -f examples/inference/rayserve/meta-llama33-70b-instruct-vllm/rayservice.yaml -n kubeflow-user-example-com
