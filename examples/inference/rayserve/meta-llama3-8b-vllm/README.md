...
To build Ray Serve engine:
    ...
    helm install --debug rayserve-llama3-8b-instruct     \
            ...
            -f examples/inference/rayserve/meta-llama3-8b-vllm/engine_config.yaml \
            -n kubeflow-user-example-com
...
To launch Ray Service,  execute:
    ...
    helm install --debug rayserve-llama3-8b-instruct \
        ...
        -f examples/inference/rayserve/meta-llama3-8b-vllm/rayservice.yaml -n kubeflow-user-example-com
