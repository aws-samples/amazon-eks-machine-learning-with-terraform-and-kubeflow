...
Uninstall the Helm chart at completion:
    ...
    helm uninstall rayserve-mixtral-8x22b-instruct-v01 -n kubeflow-user-example-com
...
To launch Ray Service,  execute:
    ...
    helm install --debug rayserve-mixtral-8x22b-instruct-v01\
        ...
        -f examples/inference/rayserve/mixtral-8x22b-instruct-v01-vllm/rayservice.yaml -n kubeflow-user-example-com
