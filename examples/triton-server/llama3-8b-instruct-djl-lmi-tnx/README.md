...
To download Hugging Face Meta Llama 3 8B Instruct  pre-trained model weights, replace `YourHuggingFaceToken` with your Hugging Face token below, and execute:
    ...
    cd ~/amazon-eks-machine-learning-with-terraform-and-kubeflow
    helm install --debug triton-server-llama3-8b-instruct-djl-lmi-tnx     \
...
Uninstall the Helm chart at completion:
    ...
    helm uninstall triton-server-llama3-8b-instruct-djl-lmi-tnx -n kubeflow-user-example-com
...
To launch Triton server:
    ...
    helm install --debug triton-server-llama3-8b-instruct-djl-lmi-tnx \
        ...
        -f examples/triton-server/llama3-8b-instruct-djl-lmi-tnx/triton_server_neuronx.yaml -n kubeflow-user-example-com
...
Triton server logs are available in `/efs/home/triton-server-llama3-8b-instruct-djl-lmi-tnx/logs` folder. 
