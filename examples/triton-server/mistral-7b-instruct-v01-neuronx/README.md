...
To download Hugging Face Mistral 7B Instruct v0.1 pre-trained model weights, replace `YourHuggingFaceToken` with your Hugging Face token below, and execute:
    ...
    cd ~/amazon-eks-machine-learning-with-terraform-and-kubeflow
    helm install --debug triton-server-mistral-7b-instruct-v01-transformers-neuronx     \
...
Uninstall the Helm chart at completion:
    ...
    helm uninstall triton-server-mistral-7b-instruct-v01-transformers-neuronx -n kubeflow-user-example-com
...
To launch Triton server:
    ...
    cd ~/amazon-eks-machine-learning-with-terraform-and-kubeflow
    helm install --debug triton-server-mistral-7b-instruct-v01-neuronx \
        charts/machine-learning/serving/triton-inference-server \
        -f examples/triton-server/mistral-7b-instruct-v01-neuronx/triton_server_neuronx.yaml -n kubeflow-user-example-com
