# Pre-train GPT Neox 20b on Wikicorpus dataset using Neuronx Distributed library
...
To launch the data processing job, execute:
    ...
    helm install --debug nxd-gpt-neox-20b \
        ...
        -f examples/legacy/neuronx-distributed/gpt_neox_20b/wikicorpus.yaml -n kubeflow-user-example-com
...
To launch compile job:
    ...
    helm install --debug nxd-gpt-neox-20b \
        ...
        -f examples/legacy/neuronx-distributed/gpt_neox_20b/compile.yaml -n kubeflow-user-example-com
...
To launch the pre-training job:
    ...
    helm install --debug nxd-gpt-neox-20b \
        charts/machine-learning/training/pytorchjob-distributed \
        -f examples/legacy/neuronx-distributed/gpt_neox_20b/pretrain.yaml -n kubeflow-user-example-com
