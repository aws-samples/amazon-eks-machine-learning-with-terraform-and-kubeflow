...
To launch the data processing job, execute:
    ...
    helm install --debug nxd-llama2-7b \
        ...
        -f examples/legacy/neuronx-distributed/llama2_7b/wikicorpus.yaml -n kubeflow-user-example-com
...
To launch compile job:
    ...
    helm install --debug nxd-llama2-7b \
        ...
        -f examples/legacy/neuronx-distributed/llama2_7b/compile.yaml -n kubeflow-user-example-com
...
To launch the pre-training job:
    ...
    helm install --debug nxd-llama2-7b \
        charts/machine-learning/training/pytorchjob-distributed \
        -f examples/legacy/neuronx-distributed/llama2_7b/pretrain.yaml -n kubeflow-user-example-com
