...
To launch the data processing job, execute:
    ...
    helm install --debug nxd-llama31-70b\
        ...
        -f examples/legacy/neuronx-distributed/llama31_70b/wikicorpus.yaml -n kubeflow-user-example-com
...
To launch compile job:
    ...
    helm install --debug nxd-llama31-70b\
        ...
        -f examples/legacy/neuronx-distributed/llama31_70b/compile.yaml -n kubeflow-user-example-com
...
To launch the pre-training job:
    ...
    helm install --debug nxd-llama31-70b\
        charts/machine-learning/training/pytorchjob-distributed \
        -f examples/legacy/neuronx-distributed/llama31_70b/pretrain.yaml -n kubeflow-user-example-com
