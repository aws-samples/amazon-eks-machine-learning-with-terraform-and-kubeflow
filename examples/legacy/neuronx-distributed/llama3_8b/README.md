# Pre-train Llama3-8B on Wikicorpus dataset using Neuronx Distributed library
...
To download Hugging Face Llama3 8B model configuration (without model weights, since we are pre-training from scratch), replace `YourHuggingFaceToken` with your Hugging Face token below, and execute:
...
To launch the data processing job, execute:
    ...
    helm install --debug nxd-llama3-8b\
        ...
        -f examples/legacy/neuronx-distributed/llama3_8b/wikicorpus.yaml -n kubeflow-user-example-com
...
To launch compile job:
    ...
    helm install --debug nxd-llama3-8b\
        ...
        -f examples/legacy/neuronx-distributed/llama3_8b/compile.yaml -n kubeflow-user-example-com
...
To launch the pre-training job:
    ...
    helm install --debug nxd-llama3-8b\
        charts/machine-learning/training/pytorchjob-distributed \
        -f examples/legacy/neuronx-distributed/llama3_8b/pretrain.yaml -n kubeflow-user-example-com
