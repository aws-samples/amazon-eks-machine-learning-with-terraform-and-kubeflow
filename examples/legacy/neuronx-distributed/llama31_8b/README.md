...
To launch the data processing job, execute:
    ...
    helm install --debug nxd-llama31-8b\
        ...
        -f examples/legacy/neuronx-distributed/llama31_8b/wikicorpus.yaml -n kubeflow-user-example-com
...
To launch compile job:
    ...
    helm install --debug nxd-llama31-8b\
        ...
        -f examples/legacy/neuronx-distributed/llama31_8b/compile.yaml -n kubeflow-user-example-com
...
To launch the pre-training job:
    ...
    helm install --debug nxd-llama31-8b\
        charts/machine-learning/training/pytorchjob-distributed \
        -f examples/legacy/neuronx-distributed/llama31_8b/pretrain.yaml -n kubeflow-user-example-com
