...
To launch the data processing job, execute:
    ...
    helm install --debug nxd-llama3-70b\
        ...
        -f examples/training/neuronx-distributed/llama3_70b/wikicorpus.yaml -n kubeflow-user-example-com
...
To launch compile job:
    ...
    helm install --debug nxd-llama3-70b\
        ...
        -f examples/training/neuronx-distributed/llama3_70b/compile.yaml -n kubeflow-user-example-com
...
To launch the pre-training job:
    ...
    helm install --debug nxd-llama3-70b\
        charts/machine-learning/training/pytorchjob-distributed \
        -f examples/training/neuronx-distributed/llama3_70b/pretrain.yaml -n kubeflow-user-example-com
