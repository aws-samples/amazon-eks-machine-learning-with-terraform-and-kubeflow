...
#VOLUMES='[{ "name": "efs", "persistentVolumeClaim": { "claimName": "kubeflow-efs-gp-bursting" }}, { "name": "ebs", "hostPath": { "path": "/local/faster-rcnn" , "type": "DirectoryOrCreate"}}]'
#VOLUME_MOUNTS='[{ "name": "efs", "mountPath": "/efs"}, { "name": "ebs", "mountPath": "/ebs"}]'
VOLUMES='[{ "name": "efs", "persistentVolumeClaim": { "claimName": "kubeflow-efs-gp-bursting" }}]'
